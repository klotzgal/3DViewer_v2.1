...
void MainWindow1::set_mainwindow_attributes() {
...
void MainWindow1::save_settings() {
...
void MainWindow1::load_settings() {
...
void MainWindow1::on_openObjBtn_clicked() {
...
void MainWindow1::on_renderBtn_clicked() {
...
void MainWindow1::on_projection_types_currentIndexChanged(int index) {
  if (index == 0) {
...
void MainWindow1::on_vert_color_val_clicked() {
  QColor vert_color =
...
void MainWindow1::on_vert_none_val_clicked() {
  ui->OpenGlWidget->v_display_method = NONE;
  ui->OpenGlWidget->update();
}

void MainWindow1::on_vert_circle_val_clicked() {
  ui->OpenGlWidget->v_display_method = CIRCLE;
  ui->OpenGlWidget->update();
}

void MainWindow1::on_vert_square_val_clicked() {
  ui->OpenGlWidget->v_display_method = SQUARE;
  ui->OpenGlWidget->update();
}

void MainWindow1::on_vert_size_val_valueChanged(int value) {
  ui->OpenGlWidget->vertices_size = value;
  ui->OpenGlWidget->update();
}

void MainWindow1::on_edge_solid_val_clicked() {
  ui->OpenGlWidget->edges_type = SOLID;
  ui->OpenGlWidget->update();
}

void MainWindow1::on_edge_dashed_val_clicked() {
  ui->OpenGlWidget->edges_type = DASHED;
  ui->OpenGlWidget->update();
}

void MainWindow1::on_edge_thic_val_valueChanged(int value) {
  ui->OpenGlWidget->edges_thickness = value / 10;
  ui->OpenGlWidget->update();
}

void MainWindow1::on_edge_color_val_clicked() {
  QColor edge_color =
      QColorDialog::getColor(Qt::white, this->ui->tabWidget, "Choose color");
...
void MainWindow1::on_background_color_val_clicked() {
  QColor bg_color =
      QColorDialog::getColor(Qt::white, this->ui->tabWidget, "Choose color");
  if (bg_color.isValid()) {
...
// void MainWindow1::on_scale_val_valueChanged(int value) {
...
// void MainWindow1::on_translate_z_val_valueChanged(int value) {
...
void MainWindow1::on_out_btn_clicked() {
  ui->scale_val->setValue(ui->scale_val->value() - 10);
}

void MainWindow1::on_in_btn_clicked() {
  ui->scale_val->setValue(ui->scale_val->value() + 10);
}

// void MainWindow1::on_snap_btn_clicked() {
//   if (isObjFile) {
...
// void MainWindow1::on_gif_btn_clicked() {
//   if (isObjFile) {
//     QDateTime current_date = QDateTime::currentDateTime();
//     QString formattedTime = current_date.toString("yyyy-MM-dd hh.mm.ss");
